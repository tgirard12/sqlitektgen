...
[ {
    ...
    "queries": {
        ...
        def expectTable = [new Table(name: "my_table", ktClass: "my_table", ktPackage: "com.tgirard12.sqlitektgen",
                columns: [new Table.Column(name: "column_1", ktField: "column_1", ktType: "String?", insertOrUpdate: true, select: true, typeAppend: "", defaultValue: "null", nullable: true, isInTable: true),
                          new Table.Column(name: "column_2", ktField: "column_2", ktType: "String?", insertOrUpdate: true, select: true, typeAppend: "", defaultValue: "null", nullable: true, isInTable: true)],
                queries: [query1: "select * from my_table",
                          query2: "select count(*) from my_table"] as HashMap<String, String>)]

        then:
        assert table.toString() == expectTable.toString()
    }
...
[ {
    ...
    "queries": {
        ...
        def expectTable = [new Table(name: "my_table", ktClass: "MyTable", ktPackage: "com.tgirard12.sqlitektgen",
                columns: [new Table.Column(name: "column_1", ktField: "column1", ktType: "Long", defaultValue: "-1", insertOrUpdate: true, select: false, typeAppend: "PRIMARY KEY", nullable: false, isInTable: true),
                          new Table.Column(name: "column_2", ktField: "other2", ktType: "Int?", defaultValue: "null", insertOrUpdate: false, select: true, typeAppend: "NOT NULL", nullable: true, isInTable: true)],
                queries: [query1: "select * from my_table",
                          query2: "select count(*) from my_table"] as HashMap<String, String>)]
